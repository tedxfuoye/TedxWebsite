          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-10 md:gap-32">
            ...
            <div className="w-full md:w-1/2">
              ...
              <p className="text-justify text-[15px] text-secondary">
                ...
                supporting our event, you're not just investing in a single day
                of inspiration – you're contributing to a lasting impact on the
                community and beyond. Your association with TEDxFUOYE
        ...
        <div className="flex flex-col-reverse md:flex-row gap-10 md:gap-44 items-start justify-between my-20 md:my-48">
          ...
          <div className="w-full md:w-2/5 text-left">
            ...
            <p className="text-secondary font-medium text-[15px] text-justify">
              We're excited to announce that our impressive lineup of sponsors
              will be unveiled at a later date. As we finalize partnerships with
              forward-looking organizations, we'll be revealing the names of the
              companies that are helping us make TEDxFUOYE a reality. Stay
              connected with us on our website and social media channels for
              updates on our sponsors and their contributions to this
              exceptional event.
            </p>
            <p className="text-secondary font-medium text-[15px] text-justify mt-20">
              TEDxFUOYE is not just an event; it's an experience that enriches
              minds, sparks conversations, and inspires change. Join us in this
              journey as a sponsor and play an integral role in shaping the
              conversations that will shape our future. For sponsorship
